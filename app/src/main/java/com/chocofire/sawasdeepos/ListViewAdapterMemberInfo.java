...
public class ListViewAdapterMemberInfo extends BaseAdapter {
    Context mContext;
    ...
    public ListViewAdapterMemberInfo(Context context, ArrayList<String> strName, ArrayList<String> strName1
            , ArrayList<String> strName2, ArrayList<String> strName3
            , ArrayList<String> strName4 ){
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if(view == null)
            view = mInflater.inflate(R.layout.listview_custom_memberinfo, parent, false);

        TextView textView = (TextView)view.findViewById(R.id.txtRightsName);
        textView.setText(strName.get(position));

        TextView textView1 = (TextView)view.findViewById(R.id.txtPkgNo);
        textView1.setText(strName1.get(position));

        TextView textView2 = (TextView)view.findViewById(R.id.txtRights);
        ...
        TextView textView4 = (TextView)view.findViewById(R.id.txtRemain);
